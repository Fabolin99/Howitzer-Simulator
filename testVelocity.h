...
private:
   ...
   void reverse_stationary()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), 0);
      assertEquals(velocity.getDY(), 0);
   } // teardown
   ...
   void reverse_up()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), 0);
      assertEquals(velocity.getDY(), -10);
   } // teardown
   ...
   void reverse_down()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), 0);
      assertEquals(velocity.getDY(), 12.34);
   } // teardown
   ...
   void reverse_left()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), 300);
      assertEquals(velocity.getDY(), 0);
   } // teardown
   ...
   void reverse_right()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), -0.0123);
      assertEquals(velocity.getDY(), 0);
   } // teardown
   ...
   void reverse_diagonal()
   {
      ...
      // verify
      assertEquals(velocity.getDX(), -123.456);
      assertEquals(velocity.getDY(), 7.89);
   } // teardown
