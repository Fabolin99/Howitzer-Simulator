...
private:
   ...
   {
       // setup
       double d0 = 0.0, r0 = 0.0;  // (d0, r0)
       double d1 = 8.0, r1 = 8.0;  // (d1, r1)

       // exercise
       double result = linearInterpolation(d0, r0, d1, r1, 0.0);
   ...
   void linearInterpolation_coordinatesOne()
   {
       ...
       // exercise
       double result = linearInterpolation(d0, r0, d1, r1, d1);
   ...
   void linearInterpolation_coordinatesMiddle()
   {
       ...
       // excercise
       double result = linearInterpolation(d0, r0, d1, r1, 4.0);
   ...
   void linearInterpolation_coordinatesTop()
   {
       ...
       // exercise
       double result = linearInterpolation(d0, r0, d1, r1, 6.0);
   ...
   {
       // setup
       double d0 = 1.0, r0 = 9.0;  // (d0, r0)
       double d1 = 7.0, r1 = -3.0;  // (d1, r1)

       // exercise
       double result = linearInterpolation(d0, r0, d1, r1, 3.0);
   ...
   void linearInterpolation_mappingMid01()
   {
       ...
       double d = 2.0;  // midway between mapping[0] and mapping[1]
       double r = -999.999;  // output
       // exercise
       r = linearInterpolation(mapping, 4 /*numMapping*/, d);
   ...
   void linearInterpolation_mappingSmall()
   {
       ...
       // verify
       assertEquals(r, 2.0);  // should return mapping[0].range
   }  // teardown
   ...
   {
       // setup
       double speedMatch = 5.00;
       double drag = -99.99;

       // exercise
       drag = dragFromMach(speedMatch);
